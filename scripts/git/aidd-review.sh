...
###############################################################################
# Script Name: "git/aidd-review.sh"
# Description: Reviews changes based on the specified parameter.
# Parameters: [optional] 'changed', 'staged', 'diff-from-main'
# Usage: aidd-review [parameter]
###############################################################################
